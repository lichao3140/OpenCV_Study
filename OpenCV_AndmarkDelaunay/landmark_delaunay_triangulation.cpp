...
RNG rng(12345);
String harr_file = "E:/lichao/study/opencv/opencv3.4/opencv/build/etc/haarcascades/haarcascade_frontalface_alt_tree.xml";
int main(int argc, char** argv) {
	Mat src = imread("face_beauty_test.jpg");
